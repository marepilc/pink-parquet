        ...
        <div class="flex max-w-64 flex-col">
            ...
            <div class="flex">
                <div class="flex flex-col">
                    <div class="mt-2 pr-2 text-right text-sm italic">
                        Created:
                    </div>
                    <div class="pr-2 text-right text-sm italic">
                        Last modified:
                    </div>
                ...
                <div class="flex flex-col">
                    <div class="mt-2 text-sm font-semibold italic">
                        {{
                            formatToLocalDateTime(
                                dataStore.fileMetadata.createdAt
                            )
                        }}
                    </div>
                    <div class="text-sm font-semibold italic">
                        {{
                            formatToLocalDateTime(
                                dataStore.fileMetadata.modifiedAt
                            )
                        }}
                    </div>
                    <div class="text-sm font-semibold italic">
